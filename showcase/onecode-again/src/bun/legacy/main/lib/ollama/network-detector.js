...
exports.clearNetworkCache = clearNetworkCache;
var debug_1 = require("../trpc/routers/debug");
var cachedStatus = {
    online: true,
    lastCheck: 0,
};
var CACHE_TTL = 10000; // 10 seconds cache
/**
...
function checkInternetConnection() {
    return __awaiter(this, void 0, void 0, function () {
        var now, endpoints, _loop_1, _i, endpoints_1, endpoint, state_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    // Check if offline mode is being simulated (for testing)
                    if ((0, debug_1.isOfflineSimulated)()) {
                    ...
                    if (now - cachedStatus.lastCheck < CACHE_TTL) {
                        return [2 /*return*/, cachedStatus.online];
                    }
                    endpoints = [
                            ...
                            switch (_b.label) {
                                ...
                                case 1:
                                    ...
                                    if (response.ok || response.status >= 400) {
                                        ...
                                        console.log("[Network] Internet check: ONLINE (via ".concat(endpoint, ")"));
