...
exports.LinuxPlatformProvider = void 0;
...
var LinuxPlatformProvider = /** @class */ (function (_super) {
    __extends(LinuxPlatformProvider, _super);
    function LinuxPlatformProvider() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.platform = "linux";
        _this.displayName = "Linux";
        return _this;
    }
    LinuxPlatformProvider.prototype.getShellConfig = function () {
    ...
    LinuxPlatformProvider.prototype.getPathConfig = function () {
    ...
    LinuxPlatformProvider.prototype.getCliConfig = function () {
        return {
    ...
    LinuxPlatformProvider.prototype.getEnvironmentConfig = function () {
        var home = this.getHome();
        return {
            homeVar: "HOME",
            userVar: "USER",
    ...
    LinuxPlatformProvider.prototype.getDefaultShell = function () {
        return process.env.SHELL || "/bin/bash";
    };
    LinuxPlatformProvider.prototype.detectShell = function () {
        return __awaiter(this, void 0, void 0, function () {
            var uid, stdout, match, _a;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.trys.push([1, 4, , 5]);
                        uid = (_b = process.getuid) === null || _b === void 0 ? void 0 : _b.call(process);
                        if (!(uid !== undefined)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.execCommand("sh", [
                                "-c",
                                "getent passwd ".concat(uid, " 2>/dev/null"),
                            ])
                    ...
                    case 4:
                        _a = _c.sent();
                        return [3 /*break*/, 5];
                    case 5: return [2 /*return*/, "/bin/bash"];
                }
            });
        });
    };
    LinuxPlatformProvider.prototype.detectLocale = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    LinuxPlatformProvider.prototype.installCli = function (sourcePath) {
        return __awaiter(this, void 0, void 0, function () {
            var cliConfig, installPath, _a, _b, error_1, errorMessage;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        if (!(0, node_fs_1.existsSync)(installPath)) return [3 /*break*/, 6];
                        _c.label = 2;
                    case 2:
                        _c.trys.push([2, 4, , 6]);
                        return [4 /*yield*/, execAsync("rm -f ".concat(installPath))];
                    case 3:
                        _c.sent();
                        return [3 /*break*/, 6];
                    case 4:
                        _a = _c.sent();
                        return [4 /*yield*/, execAsync("sudo rm -f ".concat(installPath))];
                    case 5:
                        _c.sent();
                        return [3 /*break*/, 6];
                    case 6:
                        _c.trys.push([6, 8, , 10]);
                        return [4 /*yield*/, execAsync("ln -s \"".concat(sourcePath, "\" ").concat(installPath))];
                    case 7:
                        _c.sent();
                        return [3 /*break*/, 10];
                    case 8:
                        _b = _c.sent();
                        return [4 /*yield*/, execAsync("sudo ln -s \"".concat(sourcePath, "\" ").concat(installPath))];
                    case 9:
                        _c.sent();
                        return [3 /*break*/, 10];
                    case 10:
    ...
    LinuxPlatformProvider.prototype.uninstallCli = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    LinuxPlatformProvider.prototype.isCliInstalled = function (sourcePath) {
...
exports.LinuxPlatformProvider = LinuxPlatformProvider;
