        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    _d.label = 1;
                case 1:
                    _d.trys.push([1, 4, 5, 10]);
                    client = new index_js_1.Client({
                        name: '21st-desktop',
                        version: '1.0.0',
                    });
                    shellEnv = (0, env_1.getClaudeShellEnvironment)();
                    safeEnv = {};
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    config = _a.sent();
                    serverConfig = (0, claude_config_1.getMcpServerConfig)(config, projectPath, serverName);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    config = _b.sent();
                    serverUrl = (_a = (0, claude_config_1.getMcpServerConfig)(config, pending.projectPath, pending.serverName)) === null || _a === void 0 ? void 0 : _a.url;
                    if (!serverUrl) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!(serverConfig === null || serverConfig === void 0 ? void 0 : serverConfig.url)) {
                        globalConfig = (0, claude_config_1.getMcpServerConfig)(config, claude_config_1.GLOBAL_MCP_PATH, serverName);
...
function saveTokensToClaudeJson(serverName, projectPath, tokens, clientId) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, claude_config_1.updateClaudeConfigAtomic)(function (config) {
                        // Get existing server config to preserve existing headers and determine type
                        var existingConfig = (0, claude_config_1.getMcpServerConfig)(config, projectPath, serverName) || {};
                        var serverUrl = existingConfig.url;
                        // Determine transport type from URL (SDK expects explicit type for HTTP servers)
                        var serverType = (serverUrl === null || serverUrl === void 0 ? void 0 : serverUrl.endsWith('/sse')) ? 'sse' : 'http';
                        // Build headers with Authorization (preserve any existing headers)
                        var existingHeaders = existingConfig.headers || {};
                        var headers = __assign(__assign({}, existingHeaders), { Authorization: "Bearer ".concat(tokens.accessToken) });
                        return (0, claude_config_1.updateMcpServerConfig)(config, projectPath, serverName, {
                            // SDK-required fields
                            type: serverType,
                            headers: headers,
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    config = _c.sent();
                    oauth = (_b = (0, claude_config_1.getMcpServerConfig)(config, projectPath, serverName)) === null || _b === void 0 ? void 0 : _b._oauth;
                    if (!(oauth === null || oauth === void 0 ? void 0 : oauth.accessToken))
