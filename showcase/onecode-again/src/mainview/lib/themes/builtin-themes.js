...
exports.BUILTIN_THEME_NAMES = exports.DEFAULT_DARK_THEME_ID = exports.DEFAULT_LIGHT_THEME_ID = exports.BUILTIN_THEMES = void 0;
exports.getBuiltinThemeById = getBuiltinThemeById;
exports.getBuiltinThemesByType = getBuiltinThemesByType;
...
exports.BUILTIN_THEMES = [
    ...
    TWENTYFIRST_LIGHT,
    // Cursor themes
    cursor_themes_1.CURSOR_DARK,
    cursor_themes_1.CURSOR_LIGHT,
    cursor_themes_1.CURSOR_MIDNIGHT,
    // Dark themes
    CLAUDE_DARK,
    VESPER_DARK,
    VITESSE_DARK,
 ...
 * Get theme by ID
 */
function getBuiltinThemeById(id) {
    return exports.BUILTIN_THEMES.find(function (theme) { return theme.id === id; });
}
/**
 * Get themes by type
 */
function getBuiltinThemesByType(type) {
    return exports.BUILTIN_THEMES.filter(function (theme) { return theme.type === type; });
}
/**
 * Default theme IDs for light/dark modes
 */
exports.DEFAULT_LIGHT_THEME_ID = "21st-light";
exports.DEFAULT_DARK_THEME_ID = "21st-dark";
/**
 * Set of builtin theme names (lowercase) for filtering discovered themes
 */
exports.BUILTIN_THEME_NAMES = new Set(exports.BUILTIN_THEMES.map(function (t) { return t.name.toLowerCase(); }));
