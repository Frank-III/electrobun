...
exports.CURSOR_MIDNIGHT = exports.CURSOR_LIGHT = exports.CURSOR_DARK = void 0;
/**
...
exports.CURSOR_DARK = {
    ...
    tokenColors: [
        ...
        {
            scope: "variable.parameter.function.js, variable.parameter.function.python, variable.parameter.function.language.python",
            settings: { foreground: "#f8c762" },
        },
        ...
        {
            scope: "punctuation.definition.decorator.python, entity.name.function.decorator.python, meta.function.decorator.python",
...
exports.CURSOR_LIGHT = {
    ...
    tokenColors: [
        ...
        {
            scope: "entity.name.section.markdown, punctuation.definition.heading.markdown, markup.heading.setext",
            settings: { foreground: "#141414EB" },
        },
        ...
        // C/C++
        {
            scope: "storage.type.c, storage.type.cpp, support.type.posix-reserved.c, support.type.posix-reserved.cpp",
            settings: { foreground: "#206595" },
        },
        {
            scope: "constant.language.false.cpp, constant.language.true.cpp",
