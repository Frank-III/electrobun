			...
			<DropdownMenu>
				<Tooltip>
					<TooltipTrigger asChild>
						<DropdownMenuTrigger asChild>
							...
							>
								<LuGitBranch class={cn("size-3.5 shrink-0", isCompact && "size-3")} />
								<span class="truncate max-w-[120px]">
									{currentBranch || "No branch"}
								</span>
								<HiChevronDown class={cn("size-3 shrink-0 opacity-50", isCompact && "size-2.5")} />
							</Button>
						</DropdownMenuTrigger>
					</TooltipTrigger>
				...
				<DropdownMenuContent align="start" class="w-48">
					{branches.map((branchInfo) => (
						...
						>
							<LuGitBranch class="mr-2 size-3.5" />
