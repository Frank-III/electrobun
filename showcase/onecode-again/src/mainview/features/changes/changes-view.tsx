			...
			<ContextMenuTrigger asChild>
				...
				>
					<Checkbox
						...
						class="size-4 shrink-0 border-muted-foreground/50"
					/>
				...
				{showMultiDiscard ? (
					<>
						...
						<ContextMenuItem
							...
							class="data-[highlighted]:bg-red-500/15 data-[highlighted]:text-red-400"
						>
			...
			<div class="flex flex-col h-full">
				...
				>
					...
					<TabsList class="h-8 px-2 bg-transparent border-b border-border/50 rounded-none justify-start gap-1 shrink-0">
						<TabsTrigger
							value="changes"
							class="h-6 px-2.5 text-xs rounded-md data-[state=active]:bg-muted data-[state=active]:shadow-none"
						>
							Changes
						</TabsTrigger>
						<TabsTrigger
					...
					<TabsContent value="changes" class="flex-1 flex flex-col m-0 overflow-hidden data-[state=inactive]:hidden">
						...
						<div class="flex items-center gap-2 px-2 py-1.5 border-b border-border/50">
							<Checkbox
								...
								class="size-4 border-muted-foreground/50"
							/>
						...
						{/* File list */}
						{totalCount === 0 ? (
							<div class="flex-1 flex items-center justify-center text-muted-foreground text-sm px-4 text-center">
								No changes detected
							</div>
						) : filteredCount === 0 ? (
							<div class="flex-1 flex items-center justify-center text-muted-foreground text-sm px-4 text-center">
					...
					<AlertDialogDescription asChild>
						<div class="px-5 pb-5">
							...
							<ul class="max-h-40 overflow-y-auto text-xs font-mono bg-muted/50 rounded-md p-2 space-y-0.5">
								{discardFiles?.map(f => (
									<li key={f.path} class="truncate text-muted-foreground">
										{f.path}
									</li>
								))}
							</ul>
