...
function useAgentsFileUpload() {
    ...
    var uploadFile = function (file) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            setIsUploading(true);
            // Mock upload
            setUploadedFiles(function (prev) { return __spreadArray(__spreadArray([], prev, true), [file], false); });
            setIsUploading(false);
            return [2 /*return*/, { url: URL.createObjectURL(file), filename: file.name }];
        });
    }); };
    var clearFiles = function () { return setUploadedFiles([]); };
    return {
