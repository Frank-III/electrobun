...
const GitHubAvatar = React.memo(function GitHubAvatar({
  ...
  return (
    <div class={cn(className, "relative flex-shrink-0")}>
      ...
      <img
        ...
        alt={gitOwner}
        class={cn(className, "rounded-sm flex-shrink-0", isLoaded ? 'opacity-100' : 'opacity-0')}
        onLoad={handleLoad}
        onError={handleError}
      />
    </div>
          ...
          <div class="pt-0.5">
            <div class="relative flex-shrink-0 w-4 h-4">
              {projectGitOwner && projectGitProvider === "github" ? (
                ...
                <GitHubLogo class="h-4 w-4 flex-shrink-0 text-muted-foreground" />
              )}
            </div>
          </div>
        )}
          ...
          <div class="flex items-center gap-1">
            ...
            {!isMultiSelectMode && !isMobileFullscreen && (
              <button
                ...
                tabIndex={-1}
                class="flex-shrink-0 text-muted-foreground hover:text-foreground active:text-foreground transition-[opacity,transform,color] duration-150 ease-out opacity-0 scale-95 pointer-events-none group-hover:opacity-100 group-hover:scale-100 group-hover:pointer-events-auto active:scale-[0.97]"
  ...
  return (
    ...
    >
      ...
      {isDesktop && !isFullscreen && (
        <div
          class="absolute inset-x-0 top-0 h-[32px] z-0"
          style={{
      ...
      <TrafficLights
        ...
        isDesktop={isDesktop}
        class="absolute left-4 top-[14px] z-20"
      />
          ...
          <Tooltip delayDuration={500}>
            <TooltipTrigger asChild>
              <ButtonCustom
                ...
                tabIndex={-1}
                class="h-6 w-6 p-0 hover:bg-foreground/10 transition-[background-color,transform] duration-150 ease-out active:scale-[0.97] text-foreground flex-shrink-0 rounded-md"
          ...
          <div class="flex-1 min-w-0">
            ...
            >
              <DropdownMenuTrigger asChild>
                <ButtonCustom
                  variant="ghost"
                  class="h-6 px-1.5 justify-start hover:bg-foreground/10 rounded-md group/team-button max-w-full"
                  ...
                  <>
                    ...
                    <DropdownMenuSub>
                      <DropdownMenuSubTrigger class="gap-2">
                        <QuestionCircleIcon class="h-3.5 w-3.5 text-muted-foreground flex-shrink-0" />
      ...
      <div class="flex-1 min-h-0 relative">
        ...
        >
          ...
          {drafts.length > 0 && !searchQuery && (
            <div class={cn("mb-4", isMultiSelectMode ? "px-0" : "-mx-1")}>
              <div
                class={cn(
                  "flex items-center h-4 mb-1",
                  isMultiSelectMode ? "pl-3" : "pl-2",
        ...
        <div
          ref={topGradientRef}
          class="absolute top-0 left-0 right-0 h-10 pointer-events-none bg-gradient-to-b from-tl-background via-tl-background/50 to-transparent transition-opacity duration-200 opacity-0"
        />

        {/* Bottom gradient fade */}
        <div
          ref={bottomGradientRef}
          class="absolute bottom-0 left-0 right-0 h-12 pointer-events-none bg-gradient-to-t from-tl-background via-tl-background/50 to-transparent transition-opacity duration-200 opacity-0"
        />
      </div>
          ...
          >
            ...
            <div class="flex items-center gap-1.5">
              <Button
                ...
                class="flex-1 h-8 gap-1.5 text-xs rounded-lg"
              >
                <ArchiveIcon class="h-3.5 w-3.5" />
    ...
    <>
      ...
      {typeof document !== "undefined" &&
        createPortal(
          <div
            ref={agentTooltipRef}
            class="fixed z-[100000] max-w-xs px-2 py-1 text-xs bg-popover border border-border rounded-md shadow-lg dark pointer-events-none text-foreground/90 whitespace-nowrap"
            style={{
              display: "none",
