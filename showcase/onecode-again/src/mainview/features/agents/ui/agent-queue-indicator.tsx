...
const QueueItemRow = memo(function QueueItemRow({
  ...
  return (
    <div class="flex items-center gap-2 px-3 py-1.5 text-xs hover:bg-muted/50 transition-colors cursor-default">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                ...
                class="flex-shrink-0 p-1 hover:bg-foreground/10 rounded text-muted-foreground hover:text-foreground transition-all"
              >
  ...
  return (
    ...
    >
      ...
      <div
        ...
        class="flex items-center justify-between pr-1 pl-3 h-8 cursor-pointer hover:bg-muted/50 transition-colors duration-150 focus:outline-none rounded-sm"
      >
