...
const FileDiffCard = memo(function FileDiffCard({
  ...
  return (
    <div
      ref={diffCardRef}
      class="bg-background rounded-lg border border-border overflow-clip"
            ...
            {onDiscardFile && !isDeletedFile && (
              <>
                ...
                <ContextMenuItem
                  ...
                  class="text-xs data-[highlighted]:bg-red-500/15 data-[highlighted]:text-red-400"
                >
                  Discard Changes
                </ContextMenuItem>
              </>
      ...
      {!isCollapsed && (
        <div>
          {file.isBinary ? (
            ...
            <div class="flex items-center gap-2 px-3 py-2 text-xs text-yellow-600 dark:text-yellow-500 bg-yellow-50 dark:bg-yellow-950/30">
  ...
  function AgentDiffView(
    ...
    return (
      ...
      >
        ...
        {isMobile && (
          <div
            class="flex-shrink-0 bg-background/95 backdrop-blur border-b h-11 min-h-[44px] max-h-[44px]"
          ...
          >
            <div
              class="flex h-full items-center px-2 gap-2"
              style={{
            ...
            >
              ...
              <div class="relative bg-muted rounded-md h-7 p-0.5 flex">
                <div
                  class="absolute inset-y-0.5 rounded bg-background shadow transition-all duration-200 ease-in-out"
                  style={{
                    width: "calc(50% - 2px)",
                ...
                <button
                  ...
                  class="relative z-[2] px-1.5 flex items-center justify-center transition-colors duration-200 rounded text-muted-foreground"
                  title="Split view"
                >
        ...
        <div
          ...
          class="relative flex-1 overflow-auto p-2 select-text"
        >
          {/* Sticky cover to hide content scrolling above cards */}
          <div
            class="sticky top-0 left-0 right-0 h-0 z-20 pointer-events-none"
            aria-hidden="true"
          >
          ...
          (isLoadingFileContents && fileDiffs.length === 0) ? (
            ...
            <div class="flex-1 flex items-center justify-center text-muted-foreground text-sm px-4 text-center h-full">
              No changes detected
            </div>
          )}
        </div>
