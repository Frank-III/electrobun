      ...
      <PopoverAnchor asChild>
        ...
        >
          <input
            ...
            class="w-[3ch] text-xs text-muted-foreground bg-transparent border-none outline-none text-right tabular-nums"
          />
          <span class="text-xs text-muted-foreground">%</span>
        </div>
      </PopoverAnchor>
      <PopoverContent
        class="w-[var(--radix-popover-trigger-width)] min-w-[60px] p-0"
        align="start"
        side="bottom"
        sideOffset={4}
