...
export const AgentUserQuestion = memo(forwardRef<AgentUserQuestionHandle, AgentUserQuestionProps>(
  ...
  return (
    <div class="border rounded-t-xl border-b-0 border-border bg-muted/30 overflow-hidden">
      {/* Header */}
        ...
        {questions.length > 1 && (
          <div class="flex items-center gap-1">
            <button
              ...
              class="p-0.5 rounded hover:bg-muted disabled:opacity-30 disabled:cursor-not-allowed outline-none"
            >
      ...
      <div class="flex items-center justify-end gap-2 px-2 py-2">
        ...
        <Button
          ...
          class="h-6 text-xs px-3 rounded-md"
        >
          {isSubmitting ? (
            "Sending..."
          ) : (
