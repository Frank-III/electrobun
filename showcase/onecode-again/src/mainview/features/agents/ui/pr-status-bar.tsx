...
export function PrStatusBar({ chatId, prUrl, prNumber }: PrStatusBarProps) {
  ...
  return (
    <div class="flex items-center gap-3 px-3 py-2 bg-muted/30 border-b border-border/50">
      {/* PR Link */}
      <button
        onClick={handleOpenPr}
        class="flex items-center gap-1.5 text-sm font-medium hover:underline text-foreground cursor-pointer"
      >
