...
export const AgentBashTool = memo(function AgentBashTool({
  ...
  if (isInputStreaming) {
    return (
      <div class="flex items-start gap-1.5 rounded-md py-0.5 px-2">
  ...
  return (
    <div
      ...
      class="rounded-lg border border-border bg-muted/30 overflow-hidden mx-2"
    >
            ...
            {!isPending && hasOutput && hasMoreOutput && (
              ...
              >
                {isOutputExpanded ? (
                  ...
                  <ExpandIcon class="w-4 h-4 text-muted-foreground" />
                )}
              </button>
            )}
          </div>
      ...
      >
        ...
        {stdout && (
          <div class="mt-1.5 font-mono text-xs text-muted-foreground whitespace-pre-wrap break-all">
