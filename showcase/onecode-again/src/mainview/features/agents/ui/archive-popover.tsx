        ...
        <div class="flex-1 min-w-0 flex flex-col gap-0.5">
          <div class="flex items-center gap-1">
            ...
            <button
              ...
              class="flex-shrink-0 text-muted-foreground hover:text-foreground active:text-foreground transition-[color,transform] duration-150 ease-out active:scale-[0.97]"
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent
        ...
        sideOffset={8}
        forceDark={false}
        class="w-[250px] h-[400px] p-0 flex flex-col overflow-hidden"
        ...
        <div class="p-1 border-b">
          <div class="relative flex items-center gap-1.5 h-7 px-1.5 rounded-md bg-muted/50">
            ...
            <Input
              ...
              class="h-auto p-0 border-0 bg-transparent text-sm placeholder:text-muted-foreground focus-visible:ring-0 focus-visible:ring-offset-0"
            />
          </div>
        </div>
