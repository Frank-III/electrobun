    ...
    return (
      ...
      >
        ...
        {mobileViewMode === "chats" ? (
          ...
          <div
            class="h-full w-full flex flex-col overflow-hidden select-text"
      ...
      {(process.env.NODE_ENV === "development" || isAdmin) &&
        chatData?.sandbox_id && (
          <a
            ...
            class="fixed bottom-4 right-4 z-50 bg-zinc-900 text-zinc-300 px-3 py-1.5 rounded-md text-xs font-mono opacity-70 hover:opacity-100 hover:bg-zinc-800 transition-all cursor-pointer"
          >
