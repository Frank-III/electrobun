  ...
  return (
    <div class="rounded-lg border border-border bg-muted/30 overflow-hidden mx-2">
      ...
      <div
        ...
        class="flex items-center justify-between pl-2.5 pr-0.5 h-7 cursor-pointer hover:bg-muted/50 transition-colors duration-150"
      >
        <div class="flex items-center gap-1.5 text-xs truncate flex-1 min-w-0">
          ...
          {shouldShowShimmer ? (
            ...
            <span class="truncate text-foreground font-medium">Plan</span>
          )}
        </div>
      ...
      <div class="relative">
        ...
        <div
          ref={topGradientRef}
          class="absolute top-0 left-0 right-0 h-6 pointer-events-none z-10 transition-opacity duration-150"
        ...
        <div
          ...
          class="absolute bottom-0 left-0 right-0 h-6 pointer-events-none z-10 transition-opacity duration-150"
      ...
      <div class="flex items-center justify-between p-1.5">
        <Button
          ...
          class="h-6 px-2 text-xs text-muted-foreground hover:text-foreground disabled:opacity-50"
        >
          View plan
        </Button>
        ...
        {subChatMode === "plan" && (
          <Button
            ...
            class="h-6 px-3 text-xs font-medium rounded-md transition-transform duration-150 active:scale-[0.97] disabled:opacity-50"
          >
            Approve
