  ...
  const getStatusIcon = (status: MCPServerStatus) => {
    switch (status) {
      ...
      default:
        return (
          <span
            class="w-2 h-2 rounded-full bg-muted-foreground/50"
        ...
        <TooltipTrigger asChild>
          <PopoverTrigger asChild>
            <Button
              variant="ghost"
              size="sm"
              class="h-6 px-2 gap-1.5 text-xs text-muted-foreground hover:text-foreground transition-colors rounded-md"
              ...
              <div key={server.name} role="listitem">
                ...
                {isExpanded && hasTools && (
                  <div
                    ...
                    class="pl-8 pr-3 py-1 space-y-0.5"
                    role="list"
                  ...
                  >
                    {tools.map((tool: string) => (
                      <div
                        key={tool}
                        class="text-xs text-muted-foreground py-0.5 truncate"
                        title={tool}
                        role="listitem"
                      >
                        {tool}
