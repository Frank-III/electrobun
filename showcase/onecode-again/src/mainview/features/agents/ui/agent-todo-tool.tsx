...
export const AgentTodoTool = memo(function AgentTodoTool({
  ...
  if (!isCreationToolCall && isStreaming) {
    return (
      <div class="flex items-start gap-1.5 py-0.5 rounded-md px-2">
  ...
  if (
    ...
    return (
      <div
        class="mx-2 sticky z-[5] bg-background"
  ...
  return (
    ...
    >
      ...
      <div
        class="rounded-t-lg border border-b-0 border-border bg-muted/30 px-2.5 py-1.5 cursor-pointer hover:bg-muted/40 transition-colors duration-150"
      ...
      <div class="rounded-b-lg border border-border bg-muted/20 shadow-xl shadow-background">
        ...
        {!isExpanded && (
          <div
            class="flex items-center gap-2.5 px-2.5 py-1.5 cursor-pointer hover:bg-muted/30 transition-colors duration-150"
