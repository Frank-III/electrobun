  ...
  return (
    <div>
      ...
      <div
        ...
        class="group flex items-start gap-1.5 py-0.5 px-2 cursor-pointer"
      >
          ...
          <div class="text-xs flex items-center gap-1.5 min-w-0">
            ...
            {isPending ? (
              <TextShimmer
                as="span"
                duration={1.2}
                class="font-medium whitespace-nowrap flex-shrink-0"
              >
                {getTitle()}
              </TextShimmer>
            ) : (
            ...
            {nestedTools.map((nestedPart, idx) => {
              ...
              if (!nestedMeta) {
                return (
                  <div
                    key={idx}
                    class="text-xs text-muted-foreground py-0.5 px-2"
                  >
