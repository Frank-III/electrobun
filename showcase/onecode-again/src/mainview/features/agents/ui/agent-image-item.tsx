    ...
    <>
          ...
          <HoverCard openDelay={200}>
            <HoverCardTrigger asChild>
              <img
                src={url}
                alt={filename}
                class="size-8 object-cover rounded cursor-pointer"
            ...
            <HoverCardContent class="w-auto max-w-72 p-0" side="top">
              <img
                src={url}
                alt={filename}
                class="max-w-72 max-h-72 w-auto h-auto object-contain rounded-[10px]"
                onError={handleImageError}
              />
            </HoverCardContent>
          </HoverCard>
      ...
      {isFullscreen && currentImage?.url && createPortal(
        ...
        >
          ...
          <button
            onClick={closeFullscreen}
            class="absolute top-4 right-4 p-2 rounded-full bg-black/50 hover:bg-black/70 transition-colors text-white z-10"
            type="button"
          ...
          {hasMultipleImages && (
            <button
              ...
              class="absolute left-4 top-1/2 -translate-y-1/2 p-3 rounded-full bg-black/50 hover:bg-black/70 transition-colors text-white z-10"
              type="button"
          ...
          {hasMultipleImages && (
            <button
              onClick={goToNext}
              class="absolute right-4 top-1/2 -translate-y-1/2 p-3 rounded-full bg-black/50 hover:bg-black/70 transition-colors text-white z-10"
              type="button"
