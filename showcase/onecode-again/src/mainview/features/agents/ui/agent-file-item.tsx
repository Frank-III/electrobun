...
export function AgentFileItem({
  ...
  return (
    <div
      class="relative flex items-center gap-1.5 px-2 py-1 bg-muted/50 rounded border border-border/50 max-w-[200px]"
    ...
    >
      {isLoading ? (
        ...
        <Icon class="size-3.5 text-muted-foreground flex-shrink-0" />
      )}
