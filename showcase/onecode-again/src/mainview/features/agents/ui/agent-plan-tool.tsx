...
export const AgentPlanTool = memo(function AgentPlanTool({
  ...
  return (
    <div class="rounded-lg border border-border bg-muted/30 overflow-hidden mx-2">
      ...
      <div 
        class="flex items-center justify-between px-2.5 py-2 cursor-pointer hover:bg-muted/50 transition-colors duration-150"
          ...
          {totalSteps > 0 && (
            <div class="px-2.5 py-2 border-b border-border/50">
              ...
              <div class="h-1.5 bg-muted rounded-full overflow-hidden">
                <div 
                  class="h-full bg-muted-foreground/50 transition-all duration-300 ease-out"
                    ...
                    {step.files && step.files.length > 0 && (
                      <div class="flex flex-wrap gap-1 mt-1.5">
                        {step.files.map((file, fileIdx) => (
                          <span
                            key={fileIdx}
                            class="inline-flex items-center gap-1 text-[10px] px-1.5 py-0.5 rounded bg-muted text-muted-foreground"
                          >
