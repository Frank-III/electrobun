    ...
    return (
      <div class="flex items-center gap-2 flex-1 min-w-0">
        <div class="flex-shrink-0 w-4 h-4 flex items-center justify-center relative">
          {hasPendingQuestion ? (
            <QuestionIcon class="w-4 h-4 text-blue-500" />
          ) : isLoading ? (
          ...
          {(hasPendingPlan || hasUnseen) && !isLoading && !hasPendingQuestion && (
            <div class="absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 rounded-full bg-popover flex items-center justify-center">
              <div class={cn(
          ...
          <TooltipTrigger asChild>
            <PopoverTrigger asChild>
              <Button
                variant="ghost"
                size="icon"
                class="h-6 w-6 p-0 hover:bg-foreground/10 transition-[background-color,transform] duration-150 ease-out active:scale-[0.97] flex-shrink-0 rounded-md flex items-center justify-center"
...
export function SubChatSelector({
  ...
  return (
    <div
      class="flex items-center gap-1 h-7 w-full"
      style={{
    ...
    >
      ...
      {onBackToChats && subChatsSidebarMode === "tabs" && (
        <Button
          ...
          class="h-7 w-7 p-0 hover:bg-foreground/10 transition-[background-color,transform] duration-150 ease-out active:scale-[0.97] flex-shrink-0"
      ...
      >
        ...
        <div
          ref={leftGradientRef}
          class="absolute left-0 top-0 bottom-0 w-8 bg-gradient-to-r from-background to-transparent pointer-events-none z-30"
          style={{ display: "none" }}
        />
                      ...
                      >
                        ...
                        {editingSubChatId !== subChat.id && (
                          <div class="flex-shrink-0 w-3.5 h-3.5 flex items-center justify-center relative">
                            {hasPendingQuestion ? (
                              ...
                              <QuestionIcon class="w-3.5 h-3.5 text-blue-500" />
                            ) : isLoading ? (
                              ...
                              <>
                                {/* Main mode icon */}
                                {mode === "plan" ? (
                                  <PlanIcon class="w-3.5 h-3.5 text-muted-foreground" />
                                ) : (
                                  <AgentIcon class="w-3.5 h-3.5 text-muted-foreground" />
                                )}
                                ...
                                {(hasPendingPlan || hasUnseen || isPinned) && (
                                  ...
                                  >
                                    {hasPendingPlan ? (
                                      ...
                                      <PinFilledIcon class="w-2 h-2 text-muted-foreground" />
                                    ) : null}
                                  </div>
                                )}
                              </>
                        ...
                        {editingSubChatId === subChat.id ? (
                          <InlineEdit
                            ...
                            class="text-sm !px-1 !py-0 !h-6 min-w-[100px] border border-input rounded-md !ring-0 !shadow-none focus-visible:!ring-0 focus-visible:!ring-offset-0 focus-visible:!border-input"
                          />
                        ) : (
                          <span
                            ref={(el) => {
                        ...
                        {openSubChats.length > 1 &&
                          editingSubChatId !== subChat.id && (
                            <div class="absolute right-0 top-0 bottom-0 flex items-center justify-end pr-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200 z-10">
                              <div
                                class={cn(
                              ...
                              <span
                                ...
                                class="relative z-20 hover:text-foreground rounded p-0.5 transition-[color,transform] duration-150 ease-out active:scale-[0.97] cursor-pointer"
                                title={
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    ...
                    size="icon"
                    onClick={onCreateNew}
                    class="h-6 w-6 p-0 hover:bg-foreground/10 transition-[background-color,transform] duration-150 ease-out active:scale-[0.97] rounded-md"
                  >
                    <Plus class="h-4 w-4" />
                  </Button>
                </TooltipTrigger>
      ...
      {!isMobile && canOpenDiff && showDiffButton && onOpenDiff && (
        <div
          class="rounded-md bg-background/10 backdrop-blur-[10px] flex items-center justify-center"
          style={{
            // @ts-expect-error - WebKit-specific property
            WebkitAppRegion: "no-drag",
          }}
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                size="icon"
                onClick={() => onOpenDiff?.()}
                class="h-6 w-6 p-0 transition-[background-color,transform] duration-150 ease-out active:scale-[0.97] flex-shrink-0 rounded-md flex items-center justify-center hover:bg-foreground/10"
              >
      ...
      {isMobile && onOpenDiff && canOpenDiff && (
        ...
        >
          <Button
            ...
            size="icon"
            onClick={onOpenDiff}
            class="h-7 w-7 p-0 hover:bg-foreground/10 transition-[background-color,transform] duration-150 ease-out active:scale-[0.97] flex-shrink-0 flex items-center justify-center"
          >
            <DiffIcon class="h-4 w-4" />
            <span class="sr-only">Open diff</span>
          </Button>
