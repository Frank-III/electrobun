...
export function MobileChatHeader({
  ...
  return (
    <div
      class="flex items-center gap-1.5 h-7 w-full min-w-0"
      style={{
      ...
      >
        ...
        {showOpenLocally && onOpenLocally && (
          <Button
            ...
            class="h-7 px-2.5 gap-1.5 text-xs font-medium"
          >
        ...
        <Button
          ...
          size="icon"
          onClick={onCreateNew}
          class="h-7 w-7 p-0 hover:bg-foreground/10 transition-[background-color,transform] duration-150 ease-out active:scale-[0.97] rounded-md"
        >
          <Plus class="h-4 w-4" />
        </Button>
        ...
        {isArchived && onRestore && (
          <Button
            variant="ghost"
            onClick={onRestore}
            class="h-7 px-2 gap-1.5 hover:bg-foreground/10 transition-[background-color,transform] duration-150 ease-out active:scale-[0.97] rounded-md flex items-center"
          >
