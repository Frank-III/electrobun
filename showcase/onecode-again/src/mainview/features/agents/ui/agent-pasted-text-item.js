...
exports.AgentPastedTextItem = AgentPastedTextItem;
...
function AgentPastedTextItem(_a) {
    var _b;
    var filePath = _a.filePath, filename = _a.filename, size = _a.size, preview = _a.preview, onRemove = _a.onRemove;
    ...
    return <hover_card_1.HoverCard openDelay={300} closeDelay={100}>
      <hover_card_1.HoverCardTrigger asChild>
        <div class="relative flex items-center gap-2 px-2.5 py-1.5 rounded-lg bg-muted/50 cursor-default min-w-[120px] max-w-[200px]" onMouseEnter={function () { return setIsHovered(true); }} onMouseLeave={function () { return setIsHovered(false); }}>
          {/* Icon container */}
      ...
      <hover_card_1.HoverCardContent side="top" align="start" class="w-80">
