...
const getAgentIcon = (agentId: string, className?: string) => {
  switch (agentId) {
    case "claude-code":
      return <ClaudeCodeIcon class={className} />
    case "cursor":
      return <CursorIcon class={className} />
    case "codex":
      return <CodexIcon class={className} />
    default:
      return null
  }
}
...
function CopyButton({
  ...
  return (
    <button
      onClick={handleCopy}
      tabIndex={-1}
      class="p-1.5 rounded-md transition-[background-color,transform] duration-150 ease-out hover:bg-accent active:scale-[0.97]"
    >
...
function CollapsibleSteps({
  ...
  return (
    <div class="mb-2" data-collapsible-steps="true">
      ...
      <div
        class="flex items-center justify-between rounded-md py-0.5 px-2 cursor-pointer hover:bg-muted/50 transition-colors"
                ...
                <>
                  ...
                  <div class="px-3 py-2 border-b border-border/50">
                    ...
                    {selectedCommit.description && (
                      <div class="text-xs text-foreground/80 mb-2 whitespace-pre-wrap">
                        {selectedCommit.description}
                      </div>
                    )}
...
const DiffSidebarRenderer = memo(function DiffSidebarRenderer({
  ...
  const diffViewContent = (
    <div
      ref={diffSidebarRef}
      class="flex flex-col h-full min-w-0 overflow-hidden"
    >
      ...
      {worktreePath ? (
        ...
        <div class="flex items-center h-10 px-2 border-b border-border/50 bg-background flex-shrink-0">
          <Button
            variant="ghost"
            size="sm"
            class="h-6 w-6 p-0 flex-shrink-0 hover:bg-foreground/10"
  ...
  return (
    <SearchHighlightProvider>
      ...
      <div
        ...
        class="flex-1 overflow-y-auto w-full relative allow-text-selection outline-none"
        tabIndex={-1}
        data-chat-container
      >
        <div
          class="px-2 max-w-2xl mx-auto -mb-4 space-y-4"
          style={{
            paddingBottom: "32px",
          }}
        >
      ...
      {!pendingQuestions &&
        (queue.length > 0 || changedFilesForSubChat.length > 0) && (
          <div class="px-2 -mb-6 relative z-10">
      ...
      <div class="flex-1 overflow-hidden flex">
        ...
        >
          ...
          {!shouldHideChatHeader && (
            ...
            >
              ...
              {(isMobileFullscreen || subChatsSidebarMode !== "sidebar") && (
                <div class="absolute inset-0 bg-gradient-to-b from-background via-background to-transparent" />
              )}
                        ...
                        <Tooltip delayDuration={500}>
                          <TooltipTrigger asChild>
                            <Button
                              ...
                              class="h-6 px-2 gap-1.5 text-xs font-medium ml-2"
                            >
                              {isImporting ? (
                    ...
                    <Tooltip delayDuration={500}>
                      <TooltipTrigger asChild>
                        <Button
                          ...
                          class="h-6 w-6 p-0 hover:bg-foreground/10 transition-colors text-foreground flex-shrink-0 rounded-md ml-2"
                    ...
                    <PreviewSetupHoverCard>
                      <span class="inline-flex ml-2">
                        <Button
                          ...
                          size="icon"
                          disabled
                          class="h-6 w-6 p-0 text-muted-foreground flex-shrink-0 rounded-md cursor-not-allowed pointer-events-none"
                  ...
                  <Tooltip delayDuration={500}>
                    <TooltipTrigger asChild>
                      <Button
                        ...
                        class="h-6 px-2 gap-1.5 hover:bg-foreground/10 transition-colors text-foreground flex-shrink-0 rounded-md ml-2 flex items-center"
              ...
              <div class="px-2 pb-2">
                <div class="w-full max-w-2xl mx-auto">
                  <div class="relative w-full">
                    <PromptInput
                      class="border bg-input-background relative z-10 p-2 rounded-xl opacity-50 pointer-events-none"
                      maxHeight={200}
                    >
                      ...
                      <PromptInputActions class="w-full">
                        <div class="flex items-center gap-0.5 flex-1 min-w-0">
                          ...
                          <button
                            disabled
                            class="flex items-center gap-1.5 px-2 py-1 text-sm text-muted-foreground rounded-md cursor-not-allowed"
                          >
                        ...
                        <div class="flex items-center gap-0.5 ml-auto flex-shrink-0">
                          ...
                          <Button
                            ...
                            size="icon"
                            disabled
                            class="h-7 w-7 rounded-sm cursor-not-allowed"
                          >
        ...
        {!isMobileFullscreen && activeSubChatIdForPlan && (
          <ResizableSidebar
            ...
            exitWidth={0}
            showResizeTooltip={true}
            class="bg-tl-background border-l"
            ...
            {isQuickSetup ? (
              <div class="flex flex-col h-full">
                ...
                <div class="flex items-center justify-end px-3 h-10 bg-tl-background flex-shrink-0 border-b border-border/50">
                  <Button
                    variant="ghost"
                    class="h-7 w-7 p-0 hover:bg-muted transition-[background-color,transform] duration-150 ease-out active:scale-[0.97] rounded-md"
