        ...
        <div class="flex-1 min-w-0 flex items-center gap-2">
          {isMobileFullscreen ? (
            ...
            <Button
              ...
              class="h-7 w-7 p-0 hover:bg-foreground/10 transition-[background-color,transform] duration-150 ease-out active:scale-[0.97] flex-shrink-0 rounded-md"
          ...
          {!validatedProject ? (
            ...
            <div class="flex justify-center">
              <button
                ...
                class="h-8 px-3 bg-primary text-primary-foreground rounded-lg text-sm font-medium transition-[background-color,transform] duration-150 hover:bg-primary/90 active:scale-[0.97] shadow-[0_0_0_0.5px_rgb(23,23,23),inset_0_0_0_1px_rgba(255,255,255,0.14)] disabled:opacity-50 disabled:cursor-not-allowed"
              >
                        ...
                        {modeTooltip?.visible &&
                          createPortal(
                            ...
                            >
                              <div
                                data-tooltip="true"
                                class="relative rounded-[12px] bg-popover px-2.5 py-1.5 text-xs text-popover-foreground dark max-w-[150px]"
                              >
                                <span>
                      ...
                      {availableModels.isOffline && availableModels.hasOllama ? (
                        ...
                        >
                          <DropdownMenuTrigger asChild>
                            <button
                              class="flex items-center gap-1.5 px-2 py-1 text-sm text-muted-foreground hover:text-foreground transition-[background-color,color] duration-150 ease-out rounded-md hover:bg-muted/50 outline-offset-2 focus-visible:outline focus-visible:outline-2 focus-visible:outline-ring/70 border border-border"
                            >
                              <Zap class="h-4 w-4" />
                    ...
                    <div class="flex items-center gap-0.5 ml-auto flex-shrink-0">
                      ...
                      {isVoiceRecording ? (
                        ...
                        <Button
                          variant="ghost"
                          size="icon"
                          class="h-7 w-7 rounded-sm outline-offset-2 focus-visible:outline focus-visible:outline-2 focus-visible:outline-ring/70"
                      ...
                      <PopoverContent class="w-80 p-0" align="start">
                        ...
                        <div class="flex items-center gap-1.5 h-7 px-1.5 mx-1 my-1 rounded-md bg-muted/50">
                          ...
                          <Button
                            size="sm"
                            variant="ghost"
                            class="h-6 px-1.5 flex items-center gap-1 text-xs shrink-0"
                            onClick={(e) => {
                              e.preventDefault()
                              e.stopPropagation()
                        ...
                        {filteredBranches.length === 0 ? (
                          ...
                          <div
                            ref={branchListRef}
                            class="overflow-auto py-1 scrollbar-hide"
                            style={{
                              height: Math.min(
                                ...
                                .map((virtualItem) => {
                                  ...
                                  return (
                                    ...
                                    >
                                      ...
                                      {branch.isDefault && (
                                        <span class="text-[10px] text-muted-foreground/70 bg-muted px-1.5 py-0.5 rounded shrink-0">
                                          default
                                        </span>
                                      )}
                                      {isSelected && (
                                        <CheckIcon class="h-4 w-4 shrink-0 ml-auto" />
                                      )}
                                    </button>
                                  )
                                })}
