...
export const ChatInputArea = memo(function ChatInputArea({
  ...
  return (
    <div class="px-2 pb-2 shadow-sm shadow-background relative z-10">
                ...
                <div class="flex items-center gap-0.5 flex-1 min-w-0">
                  ...
                  {availableModels.isOffline && availableModels.hasOllama ? (
                    ...
                    >
                      <DropdownMenuTrigger asChild>
                        <button
                          class="flex items-center gap-1.5 px-2 py-1 text-sm text-muted-foreground hover:text-foreground transition-colors rounded-md hover:bg-muted/50 outline-offset-2 focus-visible:outline focus-visible:outline-2 focus-visible:outline-ring/70 border border-border"
                        >
                    ...
                    >
                      ...
                      <DropdownMenuContent align="start" class="w-[200px]">
                        ...
                        <DropdownMenuSeparator />
                        <div
                          class="flex items-center justify-between px-1.5 py-1.5 mx-1"
