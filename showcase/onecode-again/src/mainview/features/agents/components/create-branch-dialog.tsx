      ...
      <CanvasDialogContent class="sm:max-w-[350px] overflow-visible">
          ...
          <div class="space-y-2">
            ...
            >
              ...
              <PopoverPrimitive.Content
                class="z-50 w-full rounded-[10px] bg-popover p-0 text-sm text-popover-foreground shadow-lg border border-border outline-none dark data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95"
                align="start"
                sideOffset={4}
        ...
        <CanvasDialogFooter>
          <Button
            ...
            disabled={createBranchMutation.isPending}
            class="transition-transform duration-150 active:scale-[0.97] rounded-md"
          >
            Cancel
          </Button>
          <Button
