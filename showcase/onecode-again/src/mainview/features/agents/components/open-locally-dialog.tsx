      ...
      {isOpen && remoteChat && (
        <>
          ...
          <div class="fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] z-[46] pointer-events-none">
            ...
            >
              <div
                class="bg-background rounded-2xl border shadow-2xl overflow-hidden"
                data-canvas-dialog
              >
                {mode === "no-projects" ? (
                    ...
                    <div class="p-6">
                      ...
                      <div class="space-y-2">
                        ...
                        <button
                          ...
                          class="w-full p-3 rounded-lg text-left bg-muted/50 hover:bg-muted transition-colors group disabled:opacity-50 disabled:cursor-not-allowed"
                        >
