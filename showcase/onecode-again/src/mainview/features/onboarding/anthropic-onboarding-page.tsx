...
export function AnthropicOnboardingPage() {
	const [flowState, setFlowState] = createSignal({ step: "idle" });
	...
	const [savedOauthUrl, setSavedOauthUrl] = createSignal(null);
	const [ignoredExistingToken, setIgnoredExistingToken] = createSignal(false);
	const [isUsingExistingToken, setIsUsingExistingToken] = createSignal(false);
	const [existingTokenError, setExistingTokenError] = createSignal(null);
	const [urlOpenedRef, setUrlOpenedRef] = createSignal(false);
