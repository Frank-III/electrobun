...
exports.RESIZE_DEBOUNCE_MS = exports.TERMINAL_OPTIONS = exports.TERMINAL_THEME = exports.TERMINAL_THEME_LIGHT = exports.TERMINAL_THEME_DARK = void 0;
exports.getTerminalTheme = getTerminalTheme;
exports.getTerminalThemeFromVSCode = getTerminalThemeFromVSCode;
var terminal_theme_mapper_1 = require("@/lib/themes/terminal-theme-mapper");
...
exports.TERMINAL_THEME = exports.TERMINAL_THEME_DARK;
/**
 * Get terminal theme based on current app theme
 */
function getTerminalTheme(isDark) {
    return isDark ? exports.TERMINAL_THEME_DARK : exports.TERMINAL_THEME_LIGHT;
}
/**
 * Get terminal theme from VS Code theme colors
 * Falls back to default themes if colors are not provided
 */
function getTerminalThemeFromVSCode(themeColors, isDark) {
    if (!themeColors) {
        return getTerminalTheme(isDark);
    }
    return (0, terminal_theme_mapper_1.extractTerminalTheme)(themeColors);
}
exports.TERMINAL_OPTIONS = {
    cursorBlink: true,
    // Font size matches app's compact UI (text-xs = 12px, text-sm = 14px)
    fontSize: 13,
    lineHeight: 1.4,
    fontFamily: TERMINAL_FONT_FAMILY,
    theme: exports.TERMINAL_THEME_DARK, // Default, will be overridden dynamically
...
exports.RESIZE_DEBOUNCE_MS = 150;
