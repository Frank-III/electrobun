      ...
      <div class="rounded-lg border border-border/50 overflow-hidden">
        ...
        <div class="flex items-center gap-2 px-2 h-8 select-none group bg-muted/30">
          ...
          <Button
            ...
            class="h-5 w-5 p-0 hover:bg-foreground/10 text-muted-foreground hover:text-foreground rounded-md transition-[background-color,transform] duration-150 ease-out active:scale-[0.97] flex-shrink-0"
