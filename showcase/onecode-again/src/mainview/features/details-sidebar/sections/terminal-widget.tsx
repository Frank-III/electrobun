  ...
  return (
    <div class="mx-2 mb-2">
      <div class={cn("rounded-lg border border-border/50 overflow-hidden")}>
        ...
        <div
          class="flex items-center gap-1 pl-1 pr-2 py-1.5 select-none group"
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                class="h-6 w-6 p-0 hover:bg-foreground/10 transition-[background-color,transform] duration-150 ease-out active:scale-[0.97] rounded-md flex-shrink-0"
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  ...
                  size="icon"
                  onClick={onExpand}
                  class="h-5 w-5 p-0 hover:bg-foreground/10 text-muted-foreground hover:text-foreground rounded-md opacity-0 group-hover:opacity-100 transition-[background-color,opacity,transform] duration-150 ease-out active:scale-[0.97] flex-shrink-0"
