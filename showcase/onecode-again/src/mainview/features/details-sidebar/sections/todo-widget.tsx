...
const TodoStatusIcon = ({
  ...
  switch (status) {
    case "completed":
      return (
        <div
          class="w-3.5 h-3.5 rounded-full bg-muted flex items-center justify-center flex-shrink-0"
    ...
    case "in_progress":
      return (
        <div class="w-3.5 h-3.5 rounded-full bg-foreground flex items-center justify-center flex-shrink-0">
...
export const TodoWidget = memo(function TodoWidget({ subChatId }: TodoWidgetProps) {
  ...
  return (
    <div class="mx-2 mb-2">
      ...
      <div
        class="rounded-t-lg border border-b-0 border-border/50 bg-muted/30 px-2 h-8 cursor-pointer hover:bg-muted/50 transition-colors duration-150 flex items-center"
      ...
      <div class="rounded-b-lg border border-border/50 border-t-0">
        ...
        {!isExpanded && (
          <div
            class="flex items-center gap-2 px-2 py-1.5 cursor-pointer hover:bg-muted/30 transition-colors duration-150"
            onClick={() => setIsExpanded(true)}
          >
            {/* Progress circle or checkmark when all completed */}
            {completedCount === totalTodos && totalTodos > 0 ? (
              <div
                class="w-4 h-4 rounded-full bg-muted flex items-center justify-center flex-shrink-0"
                style={{ border: "0.5px solid hsl(var(--border))" }}
              >
        ...
        {isExpanded && (
          <div
            class="max-h-[300px] overflow-y-auto cursor-pointer"
