...
// Discord icon
export const DiscordIcon = (props: LucideProps) => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
...
// GitHub icon
export const GitHubIcon = (props: LucideProps) => <svg viewBox="0 0 438.549 438.549" {...props}>
...
// GitHub logo
export const GitHubLogo = (props: IconProps) => <svg fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
