...
export function UpdateBanner() {
	...
	const [hasTriggeredInstall, setHasTriggeredInstall] = createSignal(false);
	...
	const [mockStatus, setMockStatus] = createSignal(MOCK_STATE === "none" ? "available" : MOCK_STATE);
	...
	const state = isMocking && MOCK_STATE === "just-updated" ? {
		status: "idle" as const,
		progress: 0
	} : isMocking ? {
		status: mockStatus === "dismissed" || mockStatus === "just-updated" ? "idle" as const : mockStatus,
