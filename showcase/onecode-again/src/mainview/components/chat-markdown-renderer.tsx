  ...
  return (
    <div class="relative mt-2 mb-4 rounded-[10px] bg-muted/50 overflow-hidden">
      <button
        onClick={handleCopy}
        tabIndex={-1}
        class="absolute top-[6px] right-[6px] p-1 z-2"
  ...
  const components = useMemo(
    () => ({
      ...
      h2: ({ children, ...props }: any) => (
        <h2 class={styles.h2} {...props}>
          {children}
        </h2>
      ),
      h3: ({ children, ...props }: any) => (
        <h3 class={styles.h3} {...props}>
          {children}
        </h3>
      ),
      h4: ({ children, ...props }: any) => (
        <h4 class={styles.h4} {...props}>
          {children}
        </h4>
      ),
      h5: ({ children, ...props }: any) => (
        <h5 class={styles.h5} {...props}>
          {children}
        </h5>
      ),
      h6: ({ children, ...props }: any) => (
        <h6 class={styles.h6} {...props}>
          {children}
        </h6>
      ),
      ...
      ol: ({ children, ...props }: any) => (
        <ol class={styles.ol} {...props}>
          {children}
        </ol>
      ),
      li: ({ children, ...props }: any) => (
        <li class={styles.li} {...props}>
          {children}
        </li>
      ),
      ...
      strong: ({ children, ...props }: any) => (
        <strong class="font-medium text-foreground" {...props}>
          {children}
        </strong>
      ),
      em: ({ children, ...props }: any) => (
        <em class="italic" {...props}>
          {children}
        </em>
      ),
      blockquote: ({ children, ...props }: any) => (
        <blockquote class={styles.blockquote} {...props}>
          {children}
        </blockquote>
      ),
      ...
      thead: ({ children, ...props }: any) => (
        <thead class={styles.thead} {...props}>
          {children}
        </thead>
      ),
      tbody: ({ children, ...props }: any) => (
        <tbody class={styles.tbody} {...props}>
          {children}
        </tbody>
      ),
      tr: ({ children, ...props }: any) => (
        <tr class={styles.tr} {...props}>
          {children}
        </tr>
      ),
      th: ({ children, ...props }: any) => (
        <th class={styles.th} {...props}>
          {children}
        </th>
      ),
      td: ({ children, ...props }: any) => (
        <td class={styles.td} {...props}>
          {children}
        </td>
      ),
