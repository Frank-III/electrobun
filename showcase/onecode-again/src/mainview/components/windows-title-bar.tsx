...
export function WindowsTitleBar() {
  ...
  return (
    <div
      class="h-8 flex-shrink-0 flex items-center justify-between bg-background border-b border-border/50"
      style={{
    ...
    >
      ...
      >
        <Button
          ...
          class="h-full w-10 rounded-none hover:bg-foreground/10"
          aria-label="Minimize"
        >
          <Minus class="h-4 w-4" />
        </Button>
        ...
        <Button
          ...
          size="icon"
          onClick={handleClose}
          class="h-full w-10 rounded-none hover:bg-red-500/20 hover:text-red-500"
          aria-label="Close"
        >
          <X class="h-4 w-4" />
        </Button>
