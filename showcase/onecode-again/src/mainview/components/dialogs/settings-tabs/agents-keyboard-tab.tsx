      ...
      <div class="mt-6 h-8 flex items-center justify-center">
        {isCustom ? (
          <button
            type="button"
            onClick={onReset}
            class="flex items-center gap-2 px-3 py-2 text-xs text-muted-foreground hover:text-foreground bg-secondary/50 hover:bg-secondary border border-border rounded-lg transition-colors"
          >
          ...
          <div class="pb-2 px-1 flex-shrink-0">
            <div class="relative">
              ...
              <input
                ...
                class="w-full h-8 pl-8 pr-3 text-sm bg-background border border-input rounded-lg placeholder:text-muted-foreground/70 transition-shadow focus-visible:border-primary focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-primary/20"
              />
            </div>
          </div>
          ...
          {hasCustomHotkeys && (
            <div class="pt-2 flex-shrink-0">
              <button
                ...
                class="w-full flex items-center justify-center gap-1.5 px-3 py-2 text-xs text-muted-foreground hover:text-foreground transition-colors"
              >
                <RotateCcw class="h-3 w-3" />
