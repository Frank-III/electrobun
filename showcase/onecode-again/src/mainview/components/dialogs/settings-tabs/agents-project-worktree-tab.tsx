      ...
      <div class="space-y-2">
        ...
        <div class="bg-background rounded-lg border border-border overflow-hidden">
          ...
          <div class="border-t">
            <button
              type="button"
              class="w-full p-3 flex items-center justify-between text-sm text-muted-foreground hover:text-foreground hover:bg-muted/50 transition-colors"
              ...
              <div class="p-4 pt-0 space-y-4">
                ...
                <div class="space-y-2">
                  ...
                  <Button
                    variant="ghost"
                    size="sm"
                    class="gap-1.5 text-muted-foreground h-7 text-xs"
