...
export function AgentsProjectWorktreeTab({ projectId }: AgentsProjectWorktreeTabProps) {
	const isNarrowScreen = useIsNarrowScreen();
	// Get config for selected project
	const { data: configData, refetch: refetchConfig } = trpc.worktreeConfig.get.useQuery({ projectId }, { enabled: !!projectId });
	// Save mutation
          ...
          <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
            ...
            <AlertDialogContent>
              ...
              <AlertDialogFooter>
                ...
                <AlertDialogAction onClick={() => deleteMutation.mutate({ id: projectId })} disabled={deleteMutation.isPending} class={buttonVariants({ variant: "destructive" })}>
