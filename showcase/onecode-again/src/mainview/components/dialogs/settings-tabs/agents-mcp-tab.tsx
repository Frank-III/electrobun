          ...
          >
            <div class="pl-10 pr-3 pb-3 space-y-1">
              {tools.map((tool) => (
                <div
                  key={tool}
                  class="text-xs text-muted-foreground font-mono py-0.5"
                >
                  {tool}
                </div>
              ))}
        ...
        <div class="flex flex-col space-y-1.5 text-center sm:text-left">
          <div class="flex items-center gap-1">
            ...
            <button
              ...
              class="h-6 w-6 inline-flex items-center justify-center text-foreground/50 hover:text-foreground disabled:opacity-50 disabled:pointer-events-none transition-colors"
            >
              {isRefreshing ? (
        ...
        <div>
          ...
          <p class="text-xs text-muted-foreground">
            ...
            <button
              ...
              class="inline-flex items-center gap-1 px-1.5 py-0.5 text-xs font-medium text-muted-foreground hover:text-foreground bg-muted hover:bg-muted/80 rounded transition-colors"
            >
          ...
          <p class="text-xs text-muted-foreground mt-1.5">
            <a
              ...
              class="text-muted-foreground hover:text-foreground underline transition-colors"
            >
