...
function ZoomControls() {
  ...
  return (
    <div class="absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-2 bg-black/50 rounded-full px-4 py-2 z-10">
      <button
        onClick={() => zoomOut()}
        class="p-1.5 rounded-full hover:bg-white/10 transition-colors text-white"
        type="button"
        aria-label="Zoom out (-)"
      >
  ...
  return (
    <>
            ...
            <div class="w-full">
              ...
              <div class="flex gap-2">
                <button
                  ...
                  class="inline-flex items-center gap-1.5 px-2.5 py-1.5 text-xs font-medium rounded-md bg-muted hover:bg-accent transition-colors"
                >
      ...
      <Dialog open={isFullscreen} onOpenChange={setIsFullscreen}>
        <DialogPortal>
          <DialogPrimitive.Overlay class="fixed inset-0 z-50 bg-black/90 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0" />
          <DialogPrimitive.Content
            class="fixed inset-0 z-50 flex items-center justify-center outline-none overflow-hidden"
          ...
          >
            ...
            <button
              ...
              class="absolute top-4 right-4 p-2 rounded-full bg-black/50 hover:bg-black/70 transition-colors text-white z-20"
              type="button"
