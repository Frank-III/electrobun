...
function RenameDialog(_a) {
    var _this = this;
    var isOpen = _a.isOpen, onClose = _a.onClose, onSave = _a.onSave, currentName = _a.currentName, _b = _a.isLoading, isLoading = _b === void 0 ? false : _b, _c = _a.title, title = _c === void 0 ? "Rename" : _c, _d = _a.placeholder, placeholder = _d === void 0 ? "Name" : _d;
    var _e = (0, solid_js_1.createSignal)(false), mounted = _e[0], setMounted = _e[1];
    var _f = (0, solid_js_1.createSignal)(currentName), name = _f[0], setName = _f[1];
    var _g = (0, solid_js_1.createSignal)(false), isSaving = _g[0], setIsSaving = _g[1];
    var _h = (0, solid_js_1.createSignal)(0), openAtRef = _h[0], setOpenAtRef = _h[1];
    ...
    return (0, web_1.createPortal)(<react_1.AnimatePresence mode="wait" initial={false}>
      {isOpen && <>
          ...
          <react_1.motion.div initial={{ opacity: 0 }} animate={{
            ...
            }} class="fixed inset-0 z-[45] bg-black/25" onClick={handleClose} style={{ pointerEvents: "auto" }} data-modal="rename-dialog"/>
            ...
            <react_1.motion.div initial={{
              ...
              <div class="bg-background rounded-2xl border shadow-2xl overflow-hidden" data-canvas-dialog>
                <div class="p-6">
                  ...
                  {/* Input */}
                  <input_1.Input ref={inputRef} value={name} onChange={function (e) { return setName(e.target.value); }} placeholder={placeholder} class="w-full h-11 text-sm" disabled={isSaving || isLoading}/>
                </div>
