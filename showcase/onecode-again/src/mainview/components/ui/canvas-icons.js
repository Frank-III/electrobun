...
function IconSpinner(props) {
    ...
    return <>
      ...
      <svg viewBox="0 0 24 24" width="16" height="16" fill="none" class={className} style={__assign({ animation: "spin 1s linear infinite" }, style)} {...rest}>
...
var CustomTerminalIcon = function (props) { return <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" {...props}>
