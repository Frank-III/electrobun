      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            class={`bg-transparent flex flex-col text-xs h-full relative ${className}`}
                  ...
                  {tooltipPosition && (
                    ...
                    >
                      <div
                        ...
                        role="dialog"
                        data-tooltip="true"
                        class="relative rounded-md border border-border bg-popover px-2 py-1 flex flex-col items-start gap-0.5 text-xs text-popover-foreground shadow-lg dark pointer-events-auto"
                        onPointerDown={(e) => {
                          e.stopPropagation()
                          if (e.button === 0) {
                            // Left mouse button
