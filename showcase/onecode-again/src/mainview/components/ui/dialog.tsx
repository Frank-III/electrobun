  ...
  (
    ...
    <DialogPortal>
      ...
      >
        {children}
        {showCloseButton && (
          <DialogPrimitive.Close class="absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground">
...
>(({ className, children, showCloseButton = true, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      {showCloseButton && (
        <DialogPrimitive.Close class="absolute right-3 top-3 h-6 w-6 rounded-full flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-muted transition-colors z-10">
...
const CanvasDialogHeader = ({
  ...
  <div class={cn("px-5 py-4", className)} {...props} />
)
...
const CanvasDialogBody = ({
  ...
  <div class={cn("px-5 pb-5", className)} {...props} />
)
