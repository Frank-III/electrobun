  ...
  return (
    <div class={`relative ${className || ""}`}>
      ...
      <svg
        viewBox="0 0 24 24"
        fill="none"
        class={`absolute inset-0 w-full h-full transition-[opacity,transform] duration-200 ease-out ${
      ...
      <div
        class={`absolute inset-0 m-auto w-[80%] h-[80%] rounded-full transition-[opacity,transform] duration-200 ease-out ${dotClassName} ${
