...
>(({ className, children, showCloseButton = false, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    >
      {children}
      {showCloseButton && (
        <AlertDialogPrimitive.Cancel class="absolute right-3 top-3 h-6 w-6 rounded-full flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-muted transition-colors z-10">
